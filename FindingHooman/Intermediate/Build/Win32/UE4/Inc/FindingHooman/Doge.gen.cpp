...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bCanSave_MetaData[];
#endif
		static void NewProp_bCanSave_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bCanSave;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ADoge_Statics::NewProp_bCanSave_MetaData[] = {
		{ "Category", "Skills" },
		{ "ModuleRelativePath", "Player/Doge.h" },
	};
#endif
	void Z_Construct_UClass_ADoge_Statics::NewProp_bCanSave_SetBit(void* Obj)
	{
		((ADoge*)Obj)->bCanSave = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ADoge_Statics::NewProp_bCanSave = { "bCanSave", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ADoge), &Z_Construct_UClass_ADoge_Statics::NewProp_bCanSave_SetBit, METADATA_PARAMS(Z_Construct_UClass_ADoge_Statics::NewProp_bCanSave_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ADoge_Statics::NewProp_bCanSave_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ADoge_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ADoge_Statics::NewProp_bCanSave,
	};
	...
	IMPLEMENT_CLASS(ADoge, 1936917640);
